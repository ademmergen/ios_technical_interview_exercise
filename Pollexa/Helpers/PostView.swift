...
class PostView: UIView {
    ...
    private func setupConstraints() {
            ...
            NSLayoutConstraint.activate([
                self.widthAnchor.constraint(equalToConstant: 388),
                ...
                optionImageView.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -196),
                ...
                totalVotesLabel.topAnchor.constraint(equalTo: self.topAnchor, constant: 300),
            ])
        }
